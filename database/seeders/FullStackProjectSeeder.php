    ...
    protected function createTasks(Roadmap $roadmap): void
    {
        $tasks = [
            [
                ...
                'learning_objectives' => ['Plan project scope', 'Create wireframes', 'Design database schema'],
                'skills_gained' => ['Project Planning', 'Requirements Analysis', 'System Design'],
                'tags' => ['planning', 'design', 'wireframes', 'schema'],
                'success_criteria' => ['Project plan complete', 'Wireframes created', 'Database schema designed'],
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Setup project structure', 'Configure environment', 'Initialize Git'],
                'skills_gained' => ['Project Setup', 'Environment Configuration', 'Git'],
                'tags' => ['setup', 'git', 'environment', 'configuration'],
                'success_criteria' => ['Project initialized', 'Git configured', 'Database connected'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Create migrations', 'Define models', 'Setup relationships'],
                'skills_gained' => ['Database Design', 'ORM', 'Data Modeling'],
                'tags' => ['database', 'migrations', 'models', 'orm'],
                'success_criteria' => ['Migrations complete', 'Models defined', 'Seeders working'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Implement authentication', 'Setup JWT', 'Create protected routes'],
                'skills_gained' => ['Authentication', 'JWT', 'Security', 'Email Verification'],
                'tags' => ['auth', 'jwt', 'security', 'email'],
                'success_criteria' => ['Registration working', 'Login with JWT', 'Email verification'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Create REST API', 'Implement validation', 'Handle errors'],
                'skills_gained' => ['REST API', 'Validation', 'Error Handling'],
                'tags' => ['api', 'crud', 'validation', 'rest'],
                'success_criteria' => ['CRUD endpoints working', 'Validation implemented', 'Errors handled'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Implement pagination', 'Add filtering', 'Create search'],
                'skills_gained' => ['Pagination', 'Filtering', 'Search', 'Advanced Queries'],
                'tags' => ['pagination', 'search', 'filter', 'api'],
                'success_criteria' => ['Pagination working', 'Filters implemented', 'Search functional'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Build layout', 'Setup routing', 'Configure state management'],
                'skills_gained' => ['React Router', 'Layout Design', 'State Management'],
                'tags' => ['frontend', 'routing', 'layout', 'state'],
                'success_criteria' => ['Layout complete', 'Routing working', 'State management setup'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Create auth forms', 'Implement validation', 'Handle auth flow'],
                'skills_gained' => ['Form Handling', 'Validation', 'Auth UI'],
                'tags' => ['forms', 'validation', 'auth', 'ui'],
                'success_criteria' => ['Auth forms complete', 'Validation working', 'Token stored'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Build UI components', 'Fetch API data', 'Display lists'],
                'skills_gained' => ['Component Design', 'API Integration', 'Data Display'],
                'tags' => ['components', 'api', 'ui', 'frontend'],
                'success_criteria' => ['Components built', 'API connected', 'Data displaying'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Create forms', 'Handle mutations', 'Manage UI states'],
                'skills_gained' => ['CRUD UI', 'State Management', 'Error Handling'],
                'tags' => ['forms', 'crud', 'state', 'ui'],
                'success_criteria' => ['Forms working', 'CRUD complete', 'States handled'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Implement file upload', 'Add search/filter', 'Create pagination UI'],
                'skills_gained' => ['File Upload', 'Search', 'Advanced Features'],
                'tags' => ['upload', 'search', 'pagination', 'filters'],
                'success_criteria' => ['File upload works', 'Search functional', 'Pagination UI complete'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Write backend tests', 'Test frontend components', 'Improve coverage'],
                'skills_gained' => ['Testing', 'Jest', 'PHPUnit', 'Quality Assurance'],
                'tags' => ['testing', 'jest', 'phpunit', 'qa'],
                'success_criteria' => ['Tests written', 'Good coverage', 'All tests passing'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Optimize performance', 'Implement caching', 'Reduce bundle size'],
                'skills_gained' => ['Performance', 'Optimization', 'Caching', 'Code Splitting'],
                'tags' => ['performance', 'optimization', 'caching', 'lazy-loading'],
                'success_criteria' => ['Performance improved', 'Caching implemented', 'Bundle optimized'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Deploy application', 'Setup CI/CD', 'Configure production'],
                'skills_gained' => ['Deployment', 'CI/CD', 'DevOps', 'Production'],
                'tags' => ['deployment', 'ci-cd', 'production', 'devops'],
                'success_criteria' => ['App deployed', 'CI/CD working', 'Production ready'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Full Stack Project',
                'learning_objectives' => ['Document project', 'Write API docs', 'Polish UI'],
                'skills_gained' => ['Documentation', 'Technical Writing', 'Project Completion'],
                'tags' => ['documentation', 'readme', 'polish', 'completion'],
                'success_criteria' => ['README complete', 'API documented', 'Project polished'],
                'has_code_submission' => true,
                'resources' => [
