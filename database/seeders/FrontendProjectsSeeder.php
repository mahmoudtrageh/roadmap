    ...
    protected function createTasks(Roadmap $roadmap): void
    {
        $tasks = [
            [
                ...
                'learning_objectives' => ['Apply CSS animations', 'Create responsive layouts', 'Implement scroll effects'],
                'skills_gained' => ['CSS Animations', 'Responsive Design', 'UI/UX'],
                'tags' => ['html', 'css', 'animations', 'responsive'],
                'success_criteria' => ['Fully responsive layout', 'Smooth animations', 'Cross-browser compatible'],
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Build dashboard layouts', 'Integrate charts', 'Create data tables'],
                'skills_gained' => ['Dashboard Design', 'Data Visualization', 'Component Structure'],
                'tags' => ['dashboard', 'charts', 'data-visualization', 'ui'],
                'success_criteria' => ['Working dashboard layout', 'Interactive charts', 'Responsive design'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Work with APIs', 'Handle async data', 'Display dynamic content'],
                'skills_gained' => ['API Integration', 'Async JavaScript', 'Error Handling'],
                'tags' => ['api', 'fetch', 'async', 'javascript'],
                'success_criteria' => ['API integration working', 'Error handling', 'Clean UI'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Implement CRUD operations', 'Use local storage', 'Manage application state'],
                'skills_gained' => ['State Management', 'Local Storage', 'CRUD Operations'],
                'tags' => ['todo', 'crud', 'local-storage', 'javascript'],
                'success_criteria' => ['Full CRUD functionality', 'Data persistence', 'Filter options'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Create product interfaces', 'Handle product variants', 'Build cart logic'],
                'skills_gained' => ['E-commerce UI', 'Shopping Cart', 'Product Display'],
                'tags' => ['e-commerce', 'product-page', 'cart', 'javascript'],
                'success_criteria' => ['Image gallery working', 'Variant selection', 'Add to cart feature'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Build portfolio layout', 'Showcase projects', 'Create contact form'],
                'skills_gained' => ['Portfolio Design', 'Personal Branding', 'Form Handling'],
                'tags' => ['portfolio', 'personal-website', 'showcase'],
                'success_criteria' => ['Professional design', 'Project showcase', 'Contact form'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Manage quiz logic', 'Handle timers', 'Track user progress'],
                'skills_gained' => ['Game Logic', 'Timer Implementation', 'Score Tracking'],
                'tags' => ['quiz', 'game', 'timer', 'javascript'],
                'success_criteria' => ['Quiz logic working', 'Timer functionality', 'Score display'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Implement search functionality', 'Work with external APIs', 'Build detailed views'],
                'skills_gained' => ['Search Implementation', 'API Integration', 'Routing'],
                'tags' => ['api', 'search', 'movies', 'javascript'],
                'success_criteria' => ['Search working', 'Movie details display', 'Clean UI'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Implement filtering system', 'Create recipe cards', 'Handle API data'],
                'skills_gained' => ['Filtering Logic', 'Card Layouts', 'API Management'],
                'tags' => ['recipes', 'filters', 'api', 'javascript'],
                'success_criteria' => ['Filter system working', 'Recipe display', 'Search functionality'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Frontend Projects',
                'learning_objectives' => ['Implement dark mode', 'Create blog layouts', 'Manage theme state'],
                'skills_gained' => ['Theme Switching', 'Blog Design', 'State Persistence'],
                'tags' => ['blog', 'dark-mode', 'theme', 'css'],
                'success_criteria' => ['Dark mode toggle', 'Blog layout complete', 'Theme persists'],
                'has_code_submission' => true,
                'resources' => [
