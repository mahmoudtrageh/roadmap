    ...
    protected function createTasks(Roadmap $roadmap): void
    {
        $tasks = [
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Understand Git workflow', 'Manage branches', 'Resolve conflicts'],
                'skills_gained' => ['Git Version Control', 'Branch Management', 'Conflict Resolution'],
                'tags' => ['git', 'version-control', 'devops'],
                'success_criteria' => ['Can perform Git operations', 'Understands merge vs rebase', 'Can resolve conflicts'],
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Understand Git Flow', 'Learn GitHub Flow', 'Use pull requests'],
                'skills_gained' => ['Git Workflows', 'Team Collaboration', 'Pull Requests'],
                'tags' => ['git', 'workflow', 'collaboration', 'pr'],
                'success_criteria' => ['Can implement Git Flow', 'Understands workflows', 'Can review PRs'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Navigate Linux filesystem', 'Manage files', 'Understand permissions'],
                'skills_gained' => ['Linux CLI', 'Shell Scripting', 'System Administration'],
                'tags' => ['linux', 'cli', 'terminal', 'bash'],
                'success_criteria' => ['Can navigate Linux', 'Understands permissions', 'Can manage processes'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Connect via SSH', 'Generate SSH keys', 'Transfer files'],
                'skills_gained' => ['SSH Protocol', 'Remote Server Management', 'Server Security'],
                'tags' => ['ssh', 'security', 'remote-access', 'devops'],
                'success_criteria' => ['Can connect securely', 'Understands SSH keys', 'Can transfer files'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Install Nginx', 'Configure Apache', 'Implement SSL/TLS'],
                'skills_gained' => ['Web Server Configuration', 'SSL/TLS Setup', 'Server Optimization'],
                'tags' => ['nginx', 'apache', 'web-server', 'ssl'],
                'success_criteria' => ['Can configure Nginx/Apache', 'Understands reverse proxy', 'Can setup SSL'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Manage environment variables', 'Configure environments', 'Deploy applications'],
                'skills_gained' => ['Deployment', 'Environment Management', 'Server Provisioning'],
                'tags' => ['deployment', 'environment', 'devops', 'production'],
                'success_criteria' => ['Can deploy to production', 'Understands environment separation', 'Can configure servers'],
                'has_code_submission' => false,
                'resources' => [
