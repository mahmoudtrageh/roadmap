    ...
    protected function createTasks(Roadmap $roadmap): void
    {
        $tasks = [
            ...
            [
                ...
                'learning_objectives' => ['Understand computer hardware components', 'Learn how binary works', 'Grasp basic computer architecture'],
                'skills_gained' => ['Computer Architecture', 'Hardware Fundamentals', 'Binary Systems'],
                'tags' => ['computer-science', 'fundamentals', 'hardware'],
                'success_criteria' => ['Can explain what a CPU does', 'Understands binary basics', 'Can describe main computer components'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Computer Science',
                'learning_objectives' => ['Learn how CPUs execute instructions', 'Understand memory hierarchy', 'Grasp data storage concepts'],
                'skills_gained' => ['CPU Operations', 'Memory Management', 'Data Storage'],
                'tags' => ['computer-science', 'cpu', 'memory'],
                'success_criteria' => ['Can explain instruction cycle', 'Understands RAM vs ROM', 'Can describe storage types'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Computer Science',
                'learning_objectives' => ['Understand basic algorithms', 'Learn about data structures', 'Grasp software concepts'],
                'skills_gained' => ['Algorithms', 'Data Structures', 'Software Fundamentals'],
                'tags' => ['computer-science', 'algorithms', 'software'],
                'success_criteria' => ['Can explain what an algorithm is', 'Understands basic data structures', 'Can describe software layers'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Computer Science',
                'learning_objectives' => ['Understand programming languages', 'Learn about compilers', 'Grasp modern computing concepts'],
                'skills_gained' => ['Programming Languages', 'Compilers', 'Modern Computing'],
                'tags' => ['computer-science', 'programming', 'compilers'],
                'success_criteria' => ['Can explain compilation', 'Understands language types', 'Can describe modern computing'],
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Understand operating system architecture', 'Learn about processes and threads', 'Grasp memory management concepts'],
                'skills_gained' => ['Operating Systems', 'Process Management', 'File Systems'],
                'tags' => ['operating-systems', 'fundamentals', 'os'],
                'success_criteria' => ['Can explain what an OS does', 'Understands process management', 'Can describe file systems'],
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Navigate file system using terminal', 'Execute basic shell commands', 'Understand pipes and redirects'],
                'skills_gained' => ['Command Line', 'Bash', 'Terminal', 'Shell Commands'],
                'tags' => ['cli', 'terminal', 'bash', 'linux'],
                'success_criteria' => ['Can navigate directories efficiently', 'Can manipulate files via CLI', 'Understands basic shell scripting'],
            ...
            [
                ...
                'learning_objectives' => ['Understand variables and data types', 'Learn basic operators and expressions', 'Grasp program structure and flow'],
                'skills_gained' => ['Programming Basics', 'Problem Solving', 'Variables'],
                'tags' => ['programming', 'fundamentals', 'basics'],
                'success_criteria' => ['Can write simple programs', 'Understands variable scope', 'Can use basic operators'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Programming',
                'learning_objectives' => ['Use conditional statements effectively', 'Implement various loop types', 'Understand break and continue'],
                'skills_gained' => ['Control Flow', 'Loops', 'Conditionals'],
                'tags' => ['loops', 'conditionals', 'control-flow'],
                'success_criteria' => ['Can use if/else correctly', 'Can implement for and while loops', 'Understands nested loops'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Programming',
                'learning_objectives' => ['Create reusable functions', 'Understand parameters and arguments', 'Learn about return values'],
                'skills_gained' => ['Functions', 'Code Reusability', 'Scope'],
                'tags' => ['functions', 'parameters', 'scope'],
                'success_criteria' => ['Can write custom functions', 'Understands function parameters', 'Can use return values'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Work with arrays effectively', 'Understand object properties and methods', 'Iterate over collections'],
                'skills_gained' => ['Arrays', 'Objects', 'Data Structures'],
                'tags' => ['arrays', 'objects', 'data-structures'],
                'success_criteria' => ['Can manipulate arrays', 'Can work with objects', 'Understands iteration methods'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Networking',
                'learning_objectives' => ['Understand how data travels on internet', 'Learn about IP addresses and routing', 'Grasp network protocols'],
                'skills_gained' => ['Internet', 'Networking', 'Protocols'],
                'tags' => ['internet', 'networking', 'protocols'],
                'success_criteria' => ['Can explain how internet works', 'Understands IP addressing', 'Knows basic network protocols'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Web',
                'learning_objectives' => ['Understand HTTP request/response cycle', 'Learn HTTP methods', 'Grasp request structure'],
                'skills_gained' => ['HTTP', 'Web Protocols', 'Request/Response'],
                'tags' => ['http', 'web', 'protocols'],
                'success_criteria' => ['Can explain HTTP methods', 'Understands request structure', 'Knows basic status codes'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Web',
                'learning_objectives' => ['Master HTTP status codes', 'Understand headers', 'Learn about cookies and sessions'],
                'skills_gained' => ['HTTP Headers', 'Status Codes', 'Cookies & Sessions'],
                'tags' => ['http', 'headers', 'cookies'],
                'success_criteria' => ['Can explain all status code categories', 'Understands common headers', 'Knows how cookies work'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Web',
                'learning_objectives' => ['Understand HTTPS encryption', 'Learn about SSL/TLS', 'Grasp certificate authority'],
                'skills_gained' => ['HTTPS', 'SSL/TLS', 'Security'],
                'tags' => ['https', 'ssl', 'security'],
                'success_criteria' => ['Can explain HTTPS encryption', 'Understands SSL certificates', 'Knows difference between HTTP and HTTPS'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Networking',
                'learning_objectives' => ['Understand DNS resolution process', 'Learn about DNS record types', 'Grasp domain name structure'],
                'skills_gained' => ['DNS', 'Domain Names', 'Networking'],
                'tags' => ['dns', 'domains', 'networking'],
                'success_criteria' => ['Can explain DNS resolution', 'Understands domain structure', 'Knows common DNS record types'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Web',
                'learning_objectives' => ['Understand browser architecture', 'Learn rendering process', 'Grasp client-server model'],
                'skills_gained' => ['Browsers', 'Client-Server', 'Web Architecture'],
                'tags' => ['browsers', 'client-server', 'web'],
                'success_criteria' => ['Can explain how browsers render pages', 'Understands client-server model', 'Knows browser components'],
                'resources' => [
