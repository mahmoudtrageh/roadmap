...
class MidLevelSkillsRoadmapSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roadmap = Roadmap::create([
            ...
            'title' => 'Phase 7: Mid-Level Skills',
    ...
    protected function createTasks(Roadmap $roadmap): void
    {
        $tasks = [
            [
                ...
                'task_type' => 'video',
                'category' => 'Testing',
                'learning_objectives' => ['Understand testing types', 'Write unit tests', 'Create feature tests'],
                'skills_gained' => ['Unit Testing', 'Integration Testing', 'PHPUnit', 'Test Coverage'],
                'tags' => ['testing', 'phpunit', 'unit-tests', 'quality'],
                'success_criteria' => ['Can write unit tests', 'Understands TDD basics', 'Can create feature tests'],
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Testing',
                'learning_objectives' => ['Understand TDD principles', 'Apply red-green-refactor', 'Write tests first'],
                'skills_gained' => ['Test-Driven Development', 'Refactoring', 'Code Design'],
                'tags' => ['tdd', 'testing', 'refactoring', 'methodology'],
                'success_criteria' => ['Can practice TDD', 'Understands TDD benefits', 'Can refactor safely'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Design',
                'learning_objectives' => ['Understand SOLID principles', 'Apply Single Responsibility', 'Implement Open-Closed'],
                'skills_gained' => ['SOLID Principles', 'Object-Oriented Design', 'Code Maintainability'],
                'tags' => ['solid', 'design-principles', 'oop', 'architecture'],
                'success_criteria' => ['Can explain SOLID', 'Can identify violations', 'Can refactor to SOLID'],
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Design',
                'learning_objectives' => ['Understand creational patterns', 'Learn structural patterns', 'Master behavioral patterns'],
                'skills_gained' => ['Design Patterns', 'Software Architecture', 'Problem Solving'],
                'tags' => ['design-patterns', 'architecture', 'oop'],
                'success_criteria' => ['Can implement patterns', 'Understands trade-offs', 'Can recognize use cases'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Understand service layer', 'Implement repository pattern', 'Separate business logic'],
                ...
                'success_criteria' => ['Can implement service layer', 'Understands repository benefits', 'Can separate concerns'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Understand caching fundamentals', 'Use Redis', 'Implement query caching'],
                'skills_gained' => ['Caching', 'Redis', 'Performance Optimization'],
                'tags' => ['caching', 'redis', 'performance', 'optimization'],
                'success_criteria' => ['Can implement caching', 'Understands invalidation', 'Can use Redis'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Performance',
                'learning_objectives' => ['Identify slow queries', 'Create indexes', 'Solve N+1 problems'],
                'skills_gained' => ['Query Optimization', 'Database Indexing', 'Performance Profiling'],
                'tags' => ['database', 'optimization', 'performance', 'sql'],
                'success_criteria' => ['Can identify N+1 queries', 'Understands indexing', 'Can profile queries'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Backend',
                'learning_objectives' => ['Create jobs', 'Configure queue workers', 'Handle failed jobs'],
                'skills_gained' => ['Queue Systems', 'Background Processing', 'Async Operations'],
                'tags' => ['queues', 'jobs', 'async', 'laravel'],
                'success_criteria' => ['Can create jobs', 'Understands queue drivers', 'Can handle failures'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Backend',
                'learning_objectives' => ['Create events and listeners', 'Implement broadcasting', 'Decouple components'],
                'skills_gained' => ['Event-Driven Architecture', 'Broadcasting', 'Real-time Features'],
                'tags' => ['events', 'listeners', 'broadcasting', 'laravel'],
                'success_criteria' => ['Can create events', 'Understands broadcasting', 'Can implement observer'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Understand Docker concepts', 'Create containers', 'Write Dockerfiles'],
                'skills_gained' => ['Docker', 'Containerization', 'Docker Compose'],
                'tags' => ['docker', 'containers', 'devops', 'deployment'],
                'success_criteria' => ['Can create containers', 'Understands Docker networking', 'Can write Dockerfiles'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'DevOps',
                'learning_objectives' => ['Understand CI/CD principles', 'Set up GitHub Actions', 'Automate testing'],
                'skills_gained' => ['CI/CD', 'GitHub Actions', 'Automation', 'DevOps'],
                'tags' => ['ci-cd', 'github-actions', 'automation', 'deployment'],
                'success_criteria' => ['Can create CI/CD pipelines', 'Understands workflow automation', 'Can setup automated testing'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Conduct code reviews', 'Provide feedback', 'Receive feedback'],
                'skills_gained' => ['Code Review', 'Team Collaboration', 'Code Quality'],
                'tags' => ['code-review', 'collaboration', 'quality', 'team'],
                'success_criteria' => ['Can review code', 'Gives constructive feedback', 'Understands review etiquette'],
                'has_code_submission' => false,
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Use debugging tools', 'Profile performance', 'Implement logging'],
                'skills_gained' => ['Debugging', 'Profiling', 'Performance Analysis', 'Problem Solving'],
                'tags' => ['debugging', 'profiling', 'performance', 'tools'],
                'success_criteria' => ['Can use debugging tools', 'Understands profiling', 'Can implement logging'],
                'has_code_submission' => false,
                'resources' => [
