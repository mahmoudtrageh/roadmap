...
class CareerSkillsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roadmap = Roadmap::create([
            ...
            'is_featured' => true,
            'order' => 13,
            'prerequisite_roadmap_id' => $phase8->id ?? null,
        ]);
    ...
    protected function createTasks(Roadmap $roadmap): void
    {
        $tasks = [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Career',
                'learning_objectives' => ['Understand ATS systems', 'Write effective CV content', 'Highlight technical skills'],
                'skills_gained' => ['CV Writing', 'Personal Branding', 'Career Marketing'],
                'tags' => ['cv', 'resume', 'career', 'job-search'],
                'success_criteria' => ['Created professional developer CV', 'Optimized for ATS', 'Highlighted key achievements'],
            ...
            [
                ...
                'task_type' => 'project',
                'category' => 'Career',
                'learning_objectives' => ['Build portfolio website', 'Showcase projects effectively', 'Create professional online presence'],
                'skills_gained' => ['Portfolio Development', 'Web Design', 'Personal Branding'],
                'tags' => ['portfolio', 'website', 'projects', 'career'],
                'success_criteria' => ['Live portfolio website', 'At least 3 projects showcased', 'Professional design'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Career',
                'learning_objectives' => ['Create impressive GitHub profile', 'Optimize repositories', 'Build online presence'],
                'skills_gained' => ['GitHub Optimization', 'Personal Branding'],
                'tags' => ['github', 'profile', 'open-source', 'career'],
                'success_criteria' => ['Professional GitHub README', 'Well-documented projects', 'Active contribution graph'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Career',
                'learning_objectives' => ['Build professional LinkedIn profile', 'Network effectively', 'Attract recruiters'],
                'skills_gained' => ['LinkedIn Optimization', 'Professional Networking'],
                'tags' => ['linkedin', 'networking', 'career', 'professional'],
                'success_criteria' => ['Complete LinkedIn profile', 'Professional photo', 'Engaging summary'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Career',
                'learning_objectives' => ['Start technical blog', 'Write technical articles', 'Build online presence'],
                'skills_gained' => ['Technical Writing', 'Content Creation', 'Personal Branding'],
                'tags' => ['blog', 'writing', 'content', 'career'],
                'success_criteria' => ['Published first blog post', 'Chose blogging platform', 'Planned content strategy'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'learning_objectives' => ['Understand interview stages', 'Prepare for each phase', 'Know what to expect'],
                'skills_gained' => ['Interview Preparation', 'Career Knowledge'],
                'tags' => ['interview', 'process', 'career', 'job-search'],
                'success_criteria' => ['Understand interview stages', 'Know preparation strategy', 'Ready for process'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Interview Prep',
                'learning_objectives' => ['Review key algorithms', 'Practice problem solving', 'Master time complexity'],
                'skills_gained' => ['DSA', 'Problem Solving', 'Coding Interviews'],
                'tags' => ['algorithms', 'data-structures', 'interview', 'coding'],
                'success_criteria' => ['Reviewed core DSA concepts', 'Solved practice problems', 'Confident with complexity'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Interview Prep',
                'learning_objectives' => ['Solve easy problems', 'Build problem-solving skills', 'Practice coding'],
                'skills_gained' => ['Problem Solving', 'Coding Speed', 'Algorithm Implementation'],
                'tags' => ['leetcode', 'coding', 'practice', 'interview'],
                'success_criteria' => ['Solved 10+ easy problems', 'Understood patterns', 'Improved speed'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Interview Prep',
                'learning_objectives' => ['Solve medium problems', 'Learn advanced patterns', 'Build confidence'],
                'skills_gained' => ['Advanced Problem Solving', 'Pattern Recognition'],
                'tags' => ['leetcode', 'algorithms', 'practice', 'interview'],
                'success_criteria' => ['Solved 5+ medium problems', 'Mastered key patterns', 'Ready for interviews'],
                'has_code_submission' => true,
                'resources' => [
            ...
            [
                ...
                'task_type' => 'video',
                'category' => 'Interview Prep',
                'learning_objectives' => ['Understand system design', 'Learn scalability concepts', 'Master design patterns'],
                'skills_gained' => ['System Design', 'Architecture', 'Scalability'],
                'tags' => ['system-design', 'architecture', 'interview', 'scalability'],
                'success_criteria' => ['Understand design principles', 'Can explain trade-offs', 'Ready for design interviews'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Interview Prep',
                'learning_objectives' => ['Master STAR method', 'Prepare stories', 'Practice answers'],
                'skills_gained' => ['Behavioral Interviews', 'Communication', 'Storytelling'],
                'tags' => ['behavioral', 'interview', 'communication', 'soft-skills'],
                'success_criteria' => ['Prepared 10+ STAR stories', 'Practiced common questions', 'Confident communicating'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Interview Prep',
                'learning_objectives' => ['Practice under pressure', 'Improve communication', 'Build confidence'],
                'skills_gained' => ['Interview Skills', 'Communication', 'Problem Solving'],
                'tags' => ['mock-interview', 'practice', 'interview', 'preparation'],
                'success_criteria' => ['Completed 3+ mock interviews', 'Improved weak areas', 'Ready for real interviews'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'reading',
                'category' => 'Career',
                'learning_objectives' => ['Learn negotiation tactics', 'Research salary data', 'Build confidence'],
                'skills_gained' => ['Negotiation', 'Communication', 'Career Strategy'],
                'tags' => ['salary', 'negotiation', 'career', 'compensation'],
                'success_criteria' => ['Know market rates', 'Prepared negotiation strategy', 'Confident discussing salary'],
                'resources' => [
            ...
            [
                ...
                'task_type' => 'exercise',
                'category' => 'Career',
                'learning_objectives' => ['Create job search plan', 'Build network', 'Master outreach'],
                'skills_gained' => ['Job Search', 'Networking', 'Professional Communication'],
                'tags' => ['job-search', 'networking', 'career', 'outreach'],
                'success_criteria' => ['Active job search strategy', 'Growing professional network', 'Regular applications'],
                'resources' => [
